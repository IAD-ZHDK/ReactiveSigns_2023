class symbol {
  constructor(startx, starty, startAngle, letter) {
    ...
    this.startOffset = random(0.15);
    this.endOffset = random(0.15);
  ...
  display() {
    ...
    let constrainedX = constrain(poster.posNormal.x, 0.3+this.startOffset, 0.7-this.endOffset);

    let lerpedPosx = map(constrainedX, 0.3+this.startOffset, 0.7-this.endOffset, this.startx, this.endx);
    let lerpedPosy = map(constrainedX, 0.3+this.startOffset, 0.7-this.endOffset, this.starty, this.endy);
